...
\begin{description}
    \item Dezibel [dB]
          \begin{align*}
              & \text{Feldgrö{\ss}e: } 20 \cdot \log_{10} \left( \dfrac{U_1}{U_2}\right) \text{; }
              \text{Leistung: } 10 \cdot \log_{10} \left( \dfrac{P_1}{P_2}\right)\\
    ...
    \item Neper [Np]
          \begin{align*}
            ...
            &1 \text{ Np } \text{ } \hat{=} 8,686 \text{ dB} % =\dfrac{20}{\ln 10} \cdot \ln \left( \dfrac{U_1}{U_2}\right)
          \end{align*}
\end{description}
