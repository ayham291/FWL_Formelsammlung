...
\begin{align*}
    ...
    \lambda                    & = \dfrac{c_0}{f}                                       \\
    v                          & = c_0                                                  \\
    \Aboxed{\underline{Z}_{F0} & = \sqrt{\dfrac{\mu_0}{\varepsilon_0}} = 120 \pi \approx377\Omega}
\end{align*}
...
\begin{align*}
    ...
    v                       & = \dfrac{c_0}{\sqrt{\mu_r\varepsilon_r}}                                                             \\
    \Aboxed{\underline{Z}_F & = \sqrt{\dfrac{\mu}{\varepsilon}}\left(1-\frac{j\sigma}{\omega\varepsilon}\right)^{-^1/2} \approx \sqrt{\dfrac{\mu}{\varepsilon}}}
\end{align*}
...
\input{Figures/Uebergang_mit_geringem_Verlust.tex}
...
\input{Figures/Senkrechter_Uebergang.tex}
