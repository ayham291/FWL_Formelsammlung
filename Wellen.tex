...
\begin{align*}
	(1) \quad \theta_g & = \arcsin \sqrt{\frac{\mu_{r2}\varepsilon_{r2}}{\mu_{r1}\varepsilon_{r1}}} &
	(2)\quad \theta_g & = \arcsin \sqrt{ \dfrac{\mu_{r1} \varepsilon_{r1}}{\mu_{r2} \varepsilon_{r2}}}&
\end{align*}
(1): bei transmittierter Welle $ \theta_t = \sin \ang{90}$\\
(2): bei einfallender Welle $ \theta_h = \sin \ang{90}$
