...
\begin{align*}
	\underline{Z}_F &= \frac{\underline{E}}{\underline{H}} = \frac{\omega \mu}{\underline{k}} = \sqrt{\frac{j\omega\mu}{\kappa+j \omega \varepsilon}}\\
	Z_{F0} &= \sqrt{\frac{\mu_0}{\varepsilon_0}} = 120\pi \Omega & Z_F & = Z_{F0} \cdot \sqrt{\frac{\mu_0}{\varepsilon_0}} &
\end{align*}
...
\begin{align*}
    ...
    v_p                        & = c_0 &
\underline{Z}_{F0} & = \sqrt{\dfrac{\mu_0}{\varepsilon_0}} = 120 \pi\Omega\approx377\Omega &
\end{align*}
\subsubsection{Im verlustlosen/idealen Dielektrikum}
...
\begin{align*}
    ...
    \boxed{\underline{Z}_F = \sqrt{\dfrac{\mu}{\varepsilon}}}
\end{align*}
