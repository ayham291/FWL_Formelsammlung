...
Keine $\vec{E}$-Felder im idealen Leiter.\\
Bildung von \textbf{Stehenden} Wellen.
\begin{equation*}
	Z_{F2}       = 0 \qquad
	r            = -1 \qquad
	t            = 0 \qquad
...
\vspace{-0.5cm}
\begin{align*}
     &\text{$H_{\text{max}}$ und $E_{\text{min}}$ bei } n \cdot \lambda/_2&
     &\text{$H_{min}$ und $E_{max}$ bei } (2n-1) \cdot \lambda/_4&
