...
%         \centering
%         \[
%             \boxed{\vec{E}(z,t) = \underbrace{E_0}_{\mathclap{\text{Amplitude}}}
...
%         \[
%             \boxed{\underline{\vec{E}}(z,t)   = \underbrace{E_0}_{\mathclap{\text{Amplitude}}}
%             \cdot \overbrace{e^{-\alpha z}}^{\mathclap{\text{Dämpfung}}}
%             \cdot \underbrace{e^{j(\omega t - \beta z)}}_\text{Zeit- und Raumabhängigkeit}
%             \cdot \vec{e}_z
%         \]
%         \[

%             = E_0\cdot e^{-\underline{\gamma z}}\cdot e^{j\omega t}}
%         \]
%     \end{minipage}
% }
\begin{empheq}[]{align*}
