...
\begin{tikzpicture}
    ...
    \draw[dotted] (-3,3) -- (0,0);
    \draw[<->] (135:0.5) arc (135:180:0.5)  node[above right] {$\alpha$};

    \draw[->] (-1.5,-1.5) -- (-2,-2)        node[above left] {$S_r$};
    \draw[->] (-1.5,-1.5) -- (-1.8,-1.2)    node[above] {$H_r$};
    \draw[-] (-1.5,-1.5) circle (0.15)      node[right] {$E_r$};
    \draw[dotted] (-3,-3) -- (0,0);
    \draw[<->] (180:0.5) arc (180:225:0.5)  node[above right] {$\alpha$};

    \draw[->] (2,-0.6666) -- (3,-1)         node[above right] {$S_t$};
    \draw[->] (2,-0.6666) -- (1.3333,-3)    node[below right] {$H_t$};
    \draw[-] (2,-0.6666) circle (0.15)      node[above] {$E_t$};
    \draw[dotted] (0,0) -- (3,-1);
    \draw[<->] (0:1) arc (0:-22.5:1)        node[above right] {$\beta$};
