\begin{tikzpicture}
    ...
    %Kreunz
    \draw[dotted] (-3,0) -- (3,0);
    \draw[-] (0,-2) -- (0,2.25)                node[below right] {$\varepsilon_{r2}, \mu_{r2}, \sigma_{r2}$}
                                            node[below left] {$\varepsilon_{r1}, \mu_{r1}, \sigma_{r1}$};
    %Rücklaufende
    \draw[-latex] (-1.5,1) -- (-2.25,1.5)          node[right] {$S_r$};
    \draw[-latex] (-1.5,1) -- (-1,1.75)          node[below] {$H_r$};
    \draw[-] (-1.5,1) circle (0.15)           node[below] {$E_r$};
    ...
    \draw[-] (-1.5,-1) circle (0.15)      node[above] {$E_h$};
    \draw[-,fill=black!100] (-1.5,-1) circle (0.05);
    \draw[dotted] (-3,-2) -- (0,0);
