...
{\footnotesize\begin{empheq}[box=\fbox]{align*}
        {\vec{H}} & =-\frac{I_0\Delta l'\beta^2}{4\pi}e^{-j\beta R}\cdot\sin\vartheta\left(\frac{1}{j\beta R}+\frac{1}{(j\beta R)^2}\right)\vec{e}_\varphi                                 \\
        {\vec{E}} & = -\frac{Z_F I_0\Delta l'\beta^2}{2\pi}e^{-j\beta R}\cdot\cos\vartheta\left(\frac{1}{(j\beta R)^2}+\frac{1}{(j\beta R)^3}\right)\vec{e}_r                           \\
...
\begin{empheq}[box=\fbox] {align*}
    \vec{H} & \approx  j\frac{\beta I_0 \Delta l'}{4\pi r}\cdot e^{-j\beta r}\cdot\sin\vartheta\cdot\vec{e}_\varphi                           \\
    \vec{E} & \approx  j\frac{\beta Z_F I_0 \Delta l'}{4\pi r}\cdot e^{-j\beta r}\cdot\sin\vartheta\cdot \vec{e}_\vartheta
\end{empheq}
