...
%siehe auch Kapitel \ref{sec:verlustlos_rfaktor_smith}.\\
...
\boxed{\left| \frac{\underline{U}}{\underline{U}_2} \right| = \sqrt{\text{Re}^2+\text{Im}^2}}
...
\end{align*}
Um $ \beta l $ über Formel zu berechnen $ \rightarrow $ \textbf{Betrag} von $ \frac{\underline{Z}(l)}{Z_L} $ bilden!\\
