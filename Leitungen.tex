...
\textbf{
    \color{red}{Leitungen gehen HIN und ZURÜCK!!!}\\
...
\begin{align*}
    U(z) & = U_h e^{\gamma z} + U_r e^{-\gamma z} = U_h e^{\gamma d} + U_r e^{-\gamma d}                       \\
    I(z) & = I_h e^{\gamma z} + I_r e^{-\gamma z} = \frac{U_h}{Z_L}e^{\gamma d} - \frac{U_r}{Z_L}e^{-\gamma d} \\
    Z_L  & = \frac{U_h}{I_h} = \sqrt{ \frac{R + j \omega L}{G + j \omega C}}
\end{align*}
...
\begin{align*}
    U(z) & = U_h\cdot  e^{\gamma z} + U_r\cdot  e^{-\gamma z} = U_h\cdot  e^{\gamma d} + U_r\cdot  e^{-\gamma d}                       \\
    I(z) & = I_h\cdot  e^{\gamma z} + I_r\cdot  e^{-\gamma z} = \frac{U_h}{Z_L}e^{\gamma d} - \frac{U_r}{Z_L}e^{-\gamma d}
\end{align*}
