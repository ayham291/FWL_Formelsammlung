...
\begin{align*}
    ...
    f_{min}           & \rightarrow \text{Minimum(Knoten) der Spannungen}                                                                               \\
    f_{max}           & \rightarrow \text{Maximum(Bäuche) der Spannungen}                                                                               \\
    \lambda_{min/max} & = \frac{c_0}{f_{min/max}\sqrt{\mu_1\varepsilon_1}}                                                                              \\
    z_{min}           & =\frac{-n\cdot\lambda_{min}}{2}                                          & \rightarrow & n = -\frac{2z}{\lambda_{min}}          \\
    z_{max}           & =\frac{-(2n+1)\lambda_{max}}{4}                                          & \rightarrow & \text{n einsetzen und nach z auflösen} \\
