...
$\bullet$ wirbelfreies Feld $\rightarrow$ Elektr. Ladungen sind Quellen des
Feldes\\
$\bullet$ Dipolmoment $\vec{p} = Q \cdot \vec{d}$
...
\begin{align*}
    ...
    E(r) & = \frac{Q}{4 \pi \varepsilon_0 r^2} \cdot \vec{e}_r
\end{align*}
...
$\bullet$ Dipolmoment $ \vec{m} = I \cdot \vec{a}$
\begin{align*}
